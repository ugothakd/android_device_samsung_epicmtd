...
#define S5PTVFB_AVALUE(r, g, b)	(((r & 0xf) << 8) | ((g & 0xf) << 4) | ((b & 0xf) << 0))
#define S5PTVFB_CHROMA(r, g, b)	(((r & 0xff) << 16) | ((g & 0xff) << 8) | ((b & 0xff) << 0))
...
void __s5p_vm_set_ctrl(s5p_tv_vmx_layer layer, bool premul, bool pixel_blending, bool blank_change, bool win_blending, s5p_tv_vmx_color_fmt color, u32 alpha, u32 blank_color);
...
extern int s5ptvfb_check_var(struct fb_var_screeninfo *var, struct fb_info *fb);
extern int s5ptvfb_set_par(struct fb_info *fb);
extern int s5ptvfb_draw_logo(struct fb_info *fb);
extern void s5ptvfb_set_lcd_info(s5p_tv_status *ctrl);
extern int s5ptvfb_display_on(s5p_tv_status *ctrl);
